...
export default function (eleventyConfig) {
	...
	for (let key in asyncShortcodes)
		eleventyConfig.addAsyncShortcode(key, asyncShortcodes[key]);

	// Filters
	eleventyConfig.addFilter("dump", (content) => {
		return JSON.stringify(content);
	});
	eleventyConfig.addFilter("ISOstring", (str) => str.toISOString());
	eleventyConfig.addFilter("LocaleDatestring", (str) =>
		str.toLocaleDateString("en-US", {
			year: "numeric",
			month: "short",
			day: "numeric",
		}),
